...
<Container class="gap-y-fluid-8">
	...
	<section>
		<h2>Summary</h2>
		<p>
			Developer with 3 years of experience in React and Typescript. Eager and motivated to learn and
			improve. Aimed to write clean code, create accessible user interfaces with best performance
			possible.
		</p>
	</section>
	<hr />
